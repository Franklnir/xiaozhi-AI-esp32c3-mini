...
public:
    ...
    virtual Display* GetDisplay() override {
        ...
        if (display == nullptr) {
            ...
            std::string oled_mode = display_settings.GetString("oled_mode", "classic");
            bool animated_mode = (oled_mode == "amoled");
            ESP_LOGI(TAG, "OLED mode: %s", animated_mode ? "amoled" : "classic");
